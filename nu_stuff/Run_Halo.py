...
# Haarcascade file info
haarcascade_files_path = "./haarcascade_xmls/"
frontal_face_xml = "haarcascade_frontalface_default.xml"

# Reference file info
ref_imgs_path = "./ref_imgs/"
ref_img = "ref_image.png"
...
face_detector = cv2.CascadeClassifier(haarcascade_files_path + frontal_face_xml)
...
ref_image = cv2.imread(ref_imgs_path + ref_img)
